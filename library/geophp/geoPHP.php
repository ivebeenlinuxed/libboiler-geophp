...
class geoPHP
{
  ...
  static function getAdapterMap() {
    return array (
      'wkt' =>  '\Library\GeoPHP\Adapter\WKT',
      'ewkt' => '\Library\GeoPHP\Adapter\EWKT',
      'wkb' =>  '\Library\GeoPHP\Adapter\WKB',
      'ewkb' => '\Library\GeoPHP\Adapter\EWKB',
      'json' => '\Library\GeoPHP\Adapter\GeoJSON',
      'kml' =>  '\Library\GeoPHP\Adapter\KML',
      'gpx' =>  '\Library\GeoPHP\Adapter\GPX',
      'georss' => '\Library\GeoPHP\Adapter\GeoRSS',
      'google_geocode' => '\Library\GeoPHP\Adapter\GoogleGeocode',
      'geohash' => '\Library\GeoPHP\Adapter\GeoHash',
    );
  }

  static function geometryList() {
    return array(
      'point' => '\Library\GeoPHP\Geometry\Point',
      'linestring' => '\Library\GeoPHP\Geometry\LineString',
      'polygon' => '\Library\GeoPHP\Geometry\Polygon',
      'multipoint' => '\Library\GeoPHP\Geometry\MultiPoint',
      'multilinestring' => '\Library\GeoPHP\Geometry\MultiLineString',
      'multipolygon' => '\Library\GeoPHP\Geometry\MultiPolygon',
      'geometrycollection' => '\Library\GeoPHP\Geometry\GeometryCollection',
    );
  }
